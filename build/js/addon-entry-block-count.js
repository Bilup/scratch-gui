      ...
      while (true) {
        ...
        const updateDisplay = () => {
          ...
          if (addon.settings.get('show_complexity_score')) {
            display.innerText = "".concat(msg("blocks", {
              num: metrics.blockCount
            }), " (").concat(msg("complexity-short"), ": ").concat(metrics.complexityScore, ")");
          } else {
