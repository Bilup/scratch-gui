...
/******/ 	deferredModules.push(["./src/playground/addon-settings.jsx","vendors~addon-settings~credits~donate~editor~embed~fullscreen~player","addon-settings~credits~donate~editor~embed~fullscreen~player","addon-settings~editor~embed~fullscreen~player"]);
