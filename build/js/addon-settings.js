...
/******/ 	deferredModules.push(["./src/playground/addon-settings.jsx","vendors~addon-settings~credits~editor~embed~fullscreen~player","addon-settings~credits~editor~embed~fullscreen~player","addon-settings~editor~embed~fullscreen~player"]);
...
const Setting = _ref7 => {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    value: value,
    values: setting.potentialValues.map(_ref8 => {
      let {
        id,
        name
      } = _ref8;
...
const UnsupportedAddons = _ref10 => {
  let {
    addons: addonList
  } = _ref10;
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
  ...
  }, settingsTranslations.unsupported), addonList.map((_ref11, index) => {
    let {
      id,
      manifest
    } = _ref11;
...
const InternalAddonList = _ref12 => {
  let {
    addons,
    extended
  } = _ref12;
  return addons.map(_ref13 => {
    let {
      id,
      manifest,
      state
...
const addonToSearchItem = _ref14 => {
  let {
    id,
    manifest
  } = _ref14;
...
class AddonList extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  ...
  render() {
    ...
    if (this.props.search) {
      ...
      const addons = search.search(this.props.search).slice(0, 20).map(_ref15 => {
        let {
          index
        } = _ref15;
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, Object.entries(groupedFilteredAddons).map(_ref16 => {
      let [id, {
        label,
        addons,
        open
...
class AddonSettingsComponent extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  ...
  render() {
    const addonState = Object.entries(supportedAddons).map(_ref17 => {
    ...
    const unsupported = Object.entries(unsupportedAddons).map(_ref18 => {
