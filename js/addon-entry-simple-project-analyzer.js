...
/***/ "./node_modules/.pnpm/css-loader@1.0.1_webpack@4.47.0/node_modules/css-loader/index.js!./src/addons/addons/simple-project-analyzer/userstyle.css":
/*!**********************************************************************************************************************************************!*\
  !*** ./node_modules/.pnpm/css-loader@1.0.1_webpack@4.47.0/node_modules/css-loader!./src/addons/addons/simple-project-analyzer/userstyle.css ***!
  \**********************************************************************************************************************************************/
...
/* harmony import */ var _css_loader_userstyle_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! css-loader!./userstyle.css */ "./node_modules/.pnpm/css-loader@1.0.1_webpack@4.47.0/node_modules/css-loader/index.js!./src/addons/addons/simple-project-analyzer/userstyle.css");
...
/***/ "./src/addons/addons/simple-project-analyzer/chart.js":
/*!************************************************************!*\
  !*** ./src/addons/addons/simple-project-analyzer/chart.js ***!
  \************************************************************/
/*! no static exports found */
...
!function (t, e) {
  ...
  class bn {
    ...
    datasetScopeKeys(t) {
      return pn(t, () => [["datasets.".concat(t), ""]]);
    }
    datasetAnimationScopeKeys(t, e) {
      return pn("".concat(t, ".transition.").concat(e), () => [["datasets.".concat(t, ".transitions.").concat(e), "transitions.".concat(e)], ["datasets.".concat(t), ""]]);
    }
    datasetElementScopeKeys(t, e) {
      return pn("".concat(t, "-").concat(e), () => [["datasets.".concat(t, ".elements.").concat(e), "datasets.".concat(t), "elements.".concat(e), ""]]);
    }
    pluginScopeKeys(t) {
      const e = t.id;
    ...
    resolveNamedOptions(t, e, i) {
      ...
      const o = {
        ...
        _xn = xn(this._resolverCache, t, s),
        a = _xn.resolver,
        r = _xn.subPrefixes;
      let l = a;
      if (function (t, e) {
    ...
    createResolver(t, e) {
      ...
      let s = arguments.length > 3 ? arguments[3] : undefined;
      const _xn2 = xn(this._resolverCache, t, i),
        n = _xn2.resolver;
      ...
      for (this._removeUnreferencedMetasets(), i = 0, s = e.length; i < s; i++) {
        ...
        if (n.type && n.type !== o && (this._destroyDatasetMeta(i), n = this.getDatasetMeta(i)), n.type = o, n.indexAxis = s.indexAxis || an(o, this.options), n.order = s.order || 0, n.index = i, n.label = "" + s.label, n.visible = this.isDatasetVisible(i), n.controller) n.controller.updateIndex(i), n.controller.linkScales();else {
          const e = en.getController(o),
            _ue$datasets$o = ue.datasets[o],
            s = _ue$datasets$o.datasetElementType,
            a = _ue$datasets$o.dataElementType;
          Object.assign(e, {
  ...
  _defineProperty(An, "version", "4.4.0");
        ...
        labels: {
          generateLabels(t) {
            ...
            if (e.labels.length && e.datasets.length) {
              const _t$legend$options$lab2 = t.legend.options.labels,
                i = _t$legend$options$lab2.pointStyle,
                s = _t$legend$options$lab2.color;
      ...
      legend: {
        labels: {
          generateLabels(t) {
            const e = t.data;
            if (e.labels.length && e.datasets.length) {
              const _t$legend$options$lab3 = t.legend.options.labels,
                i = _t$legend$options$lab3.pointStyle,
                s = _t$legend$options$lab3.color;
              return e.labels.map((e, n) => {
                const o = t.getDatasetMeta(0).controller.getStyle(n);
                return {
                  text: e,
  ...
  var Yn = Object.freeze({
    __proto__: null,
    BarController: (_Class = class BarController extends Ns {
      parsePrimitiveData(t, e, i, s) {
        return Fn(t, e, i, s);
      }
      parseArrayData(t, e, i, s) {
    ...
    }, _defineProperty(_Class, "id", "bar"), _defineProperty(_Class, "defaults", {
      datasetElementType: !1,
      dataElementType: "bar",
    ...
    BubbleController: (_Class2 = class BubbleController extends Ns {
      initialize() {
        this.enableOptionSharing = !0, super.initialize();
      }
      parsePrimitiveData(t, e, i, s) {
    ...
    }, _defineProperty(_Class2, "id", "bubble"), _defineProperty(_Class2, "defaults", {
      datasetElementType: !1,
    ...
    LineController: (_Class3 = class LineController extends Ns {
      initialize() {
    ...
    }, _defineProperty(_Class3, "id", "line"), _defineProperty(_Class3, "defaults", {
    ...
    PieController: (_Class4 = class PieController extends jn {}, _defineProperty(_Class4, "id", "pie"), _defineProperty(_Class4, "defaults", {
      cutout: 0,
      rotation: 0,
      circumference: 360,
      radius: "100%"
    ...
    RadarController: (_Class5 = class RadarController extends Ns {
      getLabelAndValue(t) {
    ...
    }, _defineProperty(_Class5, "id", "radar"), _defineProperty(_Class5, "defaults", {
      datasetElementType: "line",
      dataElementType: "point",
      indexAxis: "r",
      showLine: !0,
    ...
    ScatterController: (_Class6 = class ScatterController extends Ns {
      getLabelAndValue(t) {
        const e = this._cachedMeta,
          i = this.chart.data.labels || [],
          s = e.xScale,
    ...
    }, _defineProperty(_Class6, "id", "scatter"), _defineProperty(_Class6, "defaults", {
      datasetElementType: !1,
      dataElementType: "point",
      showLine: !1,
      fill: !1
  ...
  var fo = Object.freeze({
    ...
    ArcElement: (_Class7 = class ArcElement extends Hs {
      ...
      getCenterPoint(t) {
        const _this$getProps3 = this.getProps(["x", "y", "startAngle", "endAngle", "innerRadius", "outerRadius"], t),
          e = _this$getProps3.x,
          i = _this$getProps3.y,
    ...
    }, _defineProperty(_Class7, "id", "arc"), _defineProperty(_Class7, "defaults", {
      borderAlign: "center",
      borderColor: "#fff",
      borderDash: [],
      borderDashOffset: 0,
    ...
    BarElement: (_Class8 = class BarElement extends Hs {
      constructor(t) {
      ...
      getCenterPoint(t) {
        const _this$getProps4 = this.getProps(["x", "y", "base", "horizontal"], t),
          e = _this$getProps4.x,
          i = _this$getProps4.y,
    ...
    }, _defineProperty(_Class8, "id", "bar"), _defineProperty(_Class8, "defaults", {
      borderSkipped: "start",
      borderWidth: 0,
      borderRadius: 0,
      inflateAmount: "auto",
    ...
    LineElement: no,
    PointElement: (_Class9 = class PointElement extends Hs {
      constructor(t) {
        super(), _defineProperty(this, "parsed", void 0), _defineProperty(this, "skip", void 0), _defineProperty(this, "stop", void 0), this, this.options = void 0, this.parsed = void 0, this.skip = void 0, this.stop = void 0, t && Object.assign(this, t);
      }
      inRange(t, e, i) {
        const s = this.options,
      ...
      getCenterPoint(t) {
        const _this$getProps6 = this.getProps(["x", "y"], t),
          e = _this$getProps6.x,
          i = _this$getProps6.y;
        return {
          x: e,
    ...
    }, _defineProperty(_Class9, "id", "point"), _defineProperty(_Class9, "defaults", {
      borderWidth: 1,
      hitRadius: 1,
      hoverBorderWidth: 1,
      hoverRadius: 4,
  ...
  function mo(t, e, _ref16) {
    let i = _ref16.horizontal,
      s = _ref16.minRotation;
    const n = $(s),
  ...
  class xo extends bo {
    determineDataLimits() {
      const _this$getMinMax = this.getMinMax(!0),
  ...
  _defineProperty(xo, "id", "linear");
  _defineProperty(xo, "defaults", {
    ticks: {
  ...
  class Eo extends bo {
    ...
    determineDataLimits() {
      const _this$getMinMax3 = this.getMinMax(!1),
  ...
  class No extends Js {
    ...
    determineDataLimits() {
      const t = this.options,
        e = this._adapter,
        i = t.time.unit || "day";
      let _this$getUserBounds4 = this.getUserBounds(),
  ...
  var jo = Object.freeze({
    __proto__: null,
    CategoryScale: (_Class0 = class CategoryScale extends Js {
      constructor(t) {
      ...
      init(t) {
        ...
        if (e.length) {
          ...
          for (const _ref18 of e) {
            const i = _ref18.index;
            const s = _ref18.label;
            t[i] === s && t.splice(i, 1);
          }
          this._addedLabels = [];
        }
      ...
      determineDataLimits() {
        const _this$getUserBounds5 = this.getUserBounds(),
          t = _this$getUserBounds5.minDefined,
          e = _this$getUserBounds5.maxDefined;
        let _this$getMinMax4 = this.getMinMax(!0),
    ...
    }, _defineProperty(_Class0, "id", "category"), _defineProperty(_Class0, "defaults", {
      ticks: {
        callback: po
      }
    }), _Class0),
    ...
    TimeScale: No,
    TimeSeriesScale: (_Class1 = class TimeSeriesScale extends No {
      constructor(t) {
    ...
    }, _defineProperty(_Class1, "id", "timeseries"), _defineProperty(_Class1, "defaults", No.defaults), _Class1)
  });
                ...
                if (e === h) l < f ? (f = l, c = o) : l > g && (g = l, d = o), p = (m * p + a.x) / ++m;else {
                  ...
                  if (!s(c) && !s(d)) {
                    const e = Math.min(c, d),
                      s = Math.max(c, d);
                    e !== u && e !== i && b.push(_objectSpread(_objectSpread({}, t[e]), {}, {
                      x: p
                    })), s !== u && s !== i && b.push(_objectSpread(_objectSpread({}, t[s]), {}, {
                      x: p
                    }));
                  }
  ...
  function sa(t, e) {
    ...
    return n(t) ? (s = !0, i = t) : i = function (t, e) {
      const _ref20 = t || {},
        _ref20$x = _ref20.x,
        i = _ref20$x === void 0 ? null : _ref20$x,
        _ref20$y = _ref20.y,
        s = _ref20$y === void 0 ? null : _ref20$y,
        n = e.points,
        o = [];
      return e.segments.forEach(_ref21 => {
        let t = _ref21.start,
          e = _ref21.end;
        e = ea(t, e, n);
        const a = n[t],
  ...
  function da(t, e, i) {
    const s = ca(e),
      ...
      h = r.backgroundColor,
      _ref22 = l || {},
      _ref22$above = _ref22.above,
      c = _ref22$above === void 0 ? h : _ref22$above,
      _ref22$below = _ref22.below,
      d = _ref22$below === void 0 ? h : _ref22$below;
  ...
  function fa(t, e) {
    ...
    for (const _ref23 of r) {
      const e = _ref23.source;
      const l = _ref23.target;
      const h = _ref23.start;
      const c = _ref23.end;
      {
  ...
  class xa extends Hs {
    ...
    _fitCols(t, e, i, s) {
      ...
      return this.legendItems.forEach((t, o) => {
        const _ref25 = function (t, e, i, s, n) {
  ...
  var Ba = {
    ...
    afterDraw(t) {
      ...
      if (e && e._willRender()) {
        ...
        if (!1 === t.notifyPlugins("beforeTooltipDraw", _objectSpread(_objectSpread({}, i), {}, {
          cancelable: !0
        }))) return;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _chart_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chart.js */ "./src/addons/addons/simple-project-analyzer/chart.js");
...
/* harmony import */ var _redux_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../redux.js */ "./src/addons/redux.js");
function ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function _objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? ownKeys(Object(t), !0).forEach(function (r) { _defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
function _defineProperty(e, r, t) { return (r = _toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
function _toPropertyKey(t) { var i = _toPrimitive(t, "string"); return "symbol" == typeof i ? i : i + ""; }
...
// 注册Chart.js组件
_chart_js__WEBPACK_IMPORTED_MODULE_0__["Chart"].register(_chart_js__WEBPACK_IMPORTED_MODULE_0__["RadarController"], _chart_js__WEBPACK_IMPORTED_MODULE_0__["DoughnutController"], _chart_js__WEBPACK_IMPORTED_MODULE_0__["RadialLinearScale"], _chart_js__WEBPACK_IMPORTED_MODULE_0__["CategoryScale"], _chart_js__WEBPACK_IMPORTED_MODULE_0__["LinearScale"], _chart_js__WEBPACK_IMPORTED_MODULE_0__["PointElement"], _chart_js__WEBPACK_IMPORTED_MODULE_0__["LineElement"], _chart_js__WEBPACK_IMPORTED_MODULE_0__["ArcElement"], _chart_js__WEBPACK_IMPORTED_MODULE_0__["Filler"], _chart_js__WEBPACK_IMPORTED_MODULE_0__["Legend"], _chart_js__WEBPACK_IMPORTED_MODULE_0__["Tooltip"]);
...
/* harmony default export */ __webpack_exports__["default"] = (function (_ref) {
  ...
  class SimpleProjectAnalyzer {
    constructor() {
      ...
      _redux_js__WEBPACK_IMPORTED_MODULE_2__["default"].addEventListener('statechanged', e => {
    ...
    showAnalysisWindow() {
      ...
      this.analyzeWindow = _window_system_window_manager_js__WEBPACK_IMPORTED_MODULE_1__["default"].createWindow({
    ...
    async analyzeProjectForSidebar() {
      try {
        ...
        const loadingDiv = document.getElementById('saSAPASidebarLoading');
        if (loadingDiv) {
          loadingDiv.innerHTML = "<p style=\"color: #d32f2f;\">".concat(msg('analysis-error'), "</p>");
        }
      }
    }
    ...
    updateSidebarStats(analysis) {
      ...
      const stats = [{
        ...
        label: msg('stat-sprites'),
        value: analysis.sprites
      }, {
        label: msg('stat-costumes'),
        value: analysis.costumeCount
      }, {
        label: msg('stat-sounds'),
        value: analysis.soundCount
      }, {
        label: msg('stat-variables'),
        value: analysis.variableCount
      }, {
        label: msg('stat-lists'),
        value: analysis.listCount
      }];
      statsGrid.innerHTML = stats.map(stat => "\n        <div style=\"\n          background: var(--ui-white);\n          border-radius: 4px;\n          padding: 8px;\n          text-align: center;\n        \">\n          <div style=\"font-size: 18px; font-weight: bold; color: var(--motion-primary);\">".concat(stat.value, "</div>\n          <div style=\"font-size: 11px; color: var(--text-primary); opacity: 0.8;\">").concat(stat.label, "</div>\n        </div>\n      ")).join('');
    }
    ...
    displaySidebarCodeTypesChart(analysis) {
      ...
      const extensionColors = ['#3498DB', '#E74C3C', '#F39C12', '#27AE60', '#16A085', '#2ECC71', '#E67E22', '#95A5A6', '#34495E', '#7F8C8D', '#9B59B6', '#1ABC9C', '#2C3E50', '#F1C40F', '#D35400'];
      const standardOrder = [msg('motion'), msg('looks'), msg('sound'), msg('events'), msg('control'), msg('sensing'), msg('operators'), msg('data'), msg('custom-functions')];
      ...
      this.codeTypesChartInstance = new _chart_js__WEBPACK_IMPORTED_MODULE_0__["Chart"](ctx, {
        type: 'doughnut',
        data: {
          labels: labels,
          datasets: [{
    ...
    displaySidebarDrScratchScores(scores) {
      ...
      summaryDiv.innerHTML = "<strong>".concat(msg('total-score'), ":</strong>").concat(totalScore, " / 21<br><strong>").concat(msg('evaluation-level'), ":</strong>").concat(level);

      // 创建雷达图
      if (this.drScratchChartInstance) {
        this.drScratchChartInstance.destroy();
      }
      this.drScratchChartInstance = new _chart_js__WEBPACK_IMPORTED_MODULE_0__["Chart"](ctx, {
        type: 'radar',
        data: {
          labels: labels,
          datasets: [{
    ...
    displaySidebarMathLogicScores(scores) {
      ...
      summaryDiv.innerHTML = "<strong>".concat(msg('math-total-score'), ":</strong>").concat(totalScore, "<br><strong>").concat(msg('evaluation-level'), ":</strong>").concat(level);
      ...
      this.mathLogicChartInstance = new _chart_js__WEBPACK_IMPORTED_MODULE_0__["Chart"](ctx, {
        type: 'radar',
        data: {
          labels: labels,
          datasets: [{
    ...
    displaySidebarExtensions(extensions) {
      ...
      if (extensions.length === 0) {
        extensionList.innerHTML = "<p style=\"font-size: 12px; color: var(--text-primary); opacity: 0.7;\">".concat(msg('no-extensions'), "</p>");
        return;
      }
      extensionList.innerHTML = extensions.map(extension => {
        const color = extension.color || '#888888';
        return "\n          <div style=\"\n            background: var(--ui-white);\n            border-radius: 4px;\n            padding: 8px;\n            display: flex;\n            align-items: center;\n            gap: 8px;\n          \">\n            <div style=\"\n              width: 12px;\n              height: 12px;\n              border-radius: 50%;\n              flex-shrink: 0;\n              background-color: ".concat(color, ";\n            \"></div>\n            <div style=\"flex: 1; font-size: 12px; color: var(--text-primary);\">").concat(extension.name, "</div>\n            <div style=\"font-size: 11px; color: var(--text-primary); opacity: 0.7;\">").concat(extension.blocks.length, "</div>\n          </div>\n        ");
      }).join('');
    }
    ...
    displayCodeTypeChart(analysis) {
      ...
      // 创建新图表
      this.chartInstance = new _chart_js__WEBPACK_IMPORTED_MODULE_0__["Chart"](ctx, {
        type: 'doughnut',
        data: {
          labels: sortedLabels,
          datasets: [{
    ...
    async exportAnalysisAsImage() {
      ...
      // 获取作品名称
      const projectName = this.projectName || ((_projectJSON$info = projectJSON.info) === null || _projectJSON$info === void 0 ? void 0 : _projectJSON$info.objName) || '';
      ...
      link.download = "project-analysis-".concat(Date.now(), ".png");
    ...
    drawCodeTypeChart(ctx, analysis, width, y, padding, sectionPadding) {
      ...
      displayLabels.forEach((label, index) => {
        ...
        ctx.fillText("".concat(displayLabel, ": ").concat(displayData[index]), legendX + 14, legendY + 9);
      });
      ...
      if (labels.length > maxItems) {
        ...
        ctx.textAlign = 'left';
        ctx.fillText("+".concat(labels.length - maxItems, " more..."), legendStartX, y + 50 + Math.ceil(maxItems / 3) * 26 + 10);
      }
    ...
    drawDrScratchSection(ctx, scores, width, y, padding, sectionPadding) {
      ...
      ctx.fillStyle = '#333333';
      ctx.fillText("".concat(msg('total-score', '总分'), ": ").concat(totalScore, " / 21"), detailsX, detailsY);
      detailsY += 25;

      // 等级
      ctx.font = '14px Arial, sans-serif';
      ctx.fillStyle = '#666666';
      ctx.fillText("".concat(msg('evaluation-level', '评估等级'), ": ").concat(level), detailsX, detailsY);
      detailsY += 35;
      ...
      labels.forEach((label, index) => {
        ...
        ctx.fillStyle = '#333333';
        ctx.fillText("".concat(score, "/3"), detailsX + 260, detailsY);
        detailsY += 28;
      });
    ...
    drawMathLogicSection(ctx, scores, width, y, padding, sectionPadding) {
      ...
      // 计算等级
      let level = msg('beginner', '初级');
      if (totalScore >= 20) level = msg('advanced', '高级');else if (totalScore >= 10) level = msg('intermediate', '中级');else if (totalScore >= 5) level = msg('developing', '发展中');
      ...
      ctx.font = 'bold 18px Arial, sans-serif';
      ctx.fillStyle = '#333333';
      ctx.fillText("".concat(msg('math-total-score', '数学总分'), ": ").concat(totalScore), detailsX, detailsY);
      detailsY += 25;
      ...
      labels.forEach((label, index) => {
        ...
        ctx.fillStyle = '#333333';
        const displayLabel = label.length > 14 ? label.substring(0, 14) + '...' : label;
        ctx.fillText("".concat(displayLabel, ": ").concat(data[index]), detailsX, detailsY);
        detailsY += 28;
      });
      return y + 320 + sectionPadding;
    }
    ...
    drawExtensionsSection(ctx, extensions, width, y, padding, sectionPadding) {
      ...
      extensions.forEach((extension, index) => {
        ...
        ctx.fillStyle = '#999999';
        ctx.textAlign = 'right';
        ctx.fillText("".concat(extension.blocks.length, " ").concat(msg('blocks-count', 'blocks')), itemX + itemWidth - 18, itemY + 18);
      });
    }
