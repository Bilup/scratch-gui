...
// module
exports.push([module.i, ".sa-mcp-root {\n  display: flex;\n  white-space: nowrap;\n  font-family: \"Helvetica Neue\", Helvetica, Arial, sans-serif;\n\n  position: absolute;\n  min-width: 100px;\n  background-color: var(--ui-modal-background);\n  border-radius: 50px;\n  box-shadow: none;\n\n  z-index: 9100;\n  animation: sa-mcp-fade-in 0.15s ease-out;\n}\n\n@keyframes sa-mcp-fade-in {\n  from {\n    opacity: 0;\n    transform: translateY(-8px) scale(0.95);\n  }\n  to {\n    opacity: 1;\n    transform: translateY(0) scale(1);\n  }\n}\n\n.sa-mcp-container {\n  display: flex;\n  flex-flow: column;\n  top: -6px;\n  z-index: 100;\n  position: absolute;\n  box-shadow: none;\n  outline: none;\n  border: none;\n  border-radius: 24px;\n  overflow: hidden;\n  transition: border-radius 0.2s ease, height 0.3s ease;\n  background-color: var(--ui-primary);\n}\n\n.sa-mcp-input-wrapper {\n  position: relative;\n  margin: 12px;\n  /* !important required for extension, because CSS injection method (and hence order) differs from addon */\n  box-sizing: border-box !important;\n  height: 2rem;\n  min-height: 2rem;\n\n  /* Spotlight-like styling */\n  border-radius: 24px;\n  font-size: 0.9rem;\n  padding-left: 2.8rem;\n  padding-right: 0.5rem;\n  transition: all 0.2s ease;\n  background: var(--ui-black-transparent);\n  border: 1px solid var(--ui-black-transparent);\n}\n\n.sa-mcp-input-wrapper:focus-within {\n  /* Spotlight-like focused state */\n  box-shadow: 0 0 0 2px rgba(77, 151, 255, 0.3);\n  border-color: rgba(77, 151, 255, 0.6);\n  background: rgba(255, 255, 255, 0.9);\n}\n\n.sa-mcp-input-wrapper:focus-within .sa-mcp-search-icon {\n  opacity: 0.7;\n}\n\n.sa-mcp-search-icon {\n  position: absolute;\n  left: 10px;\n  top: 50%;\n  transform: translateY(-50%);\n  width: 14px;\n  height: 14px;\n  opacity: 0.5;\n  pointer-events: none;\n  transition: opacity 0.2s ease;\n  z-index: 1;\n}\n\n.sa-mcp-input-wrapper:focus-within .sa-mcp-search-icon {\n  opacity: 0.6;\n}\n\n.sa-mcp-input-wrapper[data-error=\"true\"] {\n  border-color: #ff6680;\n  box-shadow: 0 0 0 3px rgba(255, 102, 128, 0.2);\n}\n\n.sa-mcp-input-wrapper > input {\n  left: 0;\n  position: absolute;\n  border: 0;\n  outline: none;\n  width: 100%;\n  height: 100%;\n  line-height: 2rem;\n  box-sizing: border-box;\n  padding-left: 2rem;\n  padding-right: 1rem;\n  font-size: 0.9rem;\n  background-color: var(--ui-secondary);\n  color: var(--text-primary);\n}\n\n.sa-mcp-input-wrapper > input::placeholder {\n  color: var(--text-primary);\n  opacity: 0.3;\n}\n\n.sa-mcp-input-suggestion {\n  color: hsla(225, 15%, 40%, 0.5);\n  pointer-events: none;\n}\n\n.sa-mcp-result-box {\n  margin: 0 12px 8px 12px;\n  padding: 20px 12px;\n  background: linear-gradient(135deg, rgba(76, 209, 55, 0.08) 0%, rgba(76, 209, 55, 0.03) 100%);\n  border: 1px solid rgba(76, 209, 55, 0.2);\n  border-radius: 12px;\n  font-size: 0.875rem;\n  font-weight: 500;\n  color: #71cc5d;\n  text-align: center;\n  font-family: 'Monaco', 'Menlo', 'Ubuntu Mono', monospace;\n  letter-spacing: 0.5px;\n  animation: sa-mcp-result-appear 0.2s ease-out;\n  box-shadow: 0 1px 4px rgba(76, 209, 55, 0.1);\n}\n\n.sa-mcp-result-box.sa-mcp-result-conversion {\n  background: linear-gradient(135deg, rgba(77, 151, 255, 0.08) 0%, rgba(77, 151, 255, 0.03) 100%);\n  border-color: rgba(77, 151, 255, 0.2);\n  color: #7ba5dc;\n  box-shadow: 0 1px 4px rgba(77, 151, 255, 0.1);\n}\n\n@keyframes sa-mcp-result-appear {\n  from {\n    opacity: 0;\n    transform: translateY(-4px) scale(0.98);\n  }\n  to {\n    opacity: 1;\n    transform: translateY(0) scale(1);\n  }\n}\n\n.sa-mcp-preview-container {\n  flex: auto;\n  overflow-y: scroll;\n  scroll-behavior: smooth;\n}\n\n.sa-mcp-root /* <-- specificity */ .sa-mcp-preview-container {\n  scrollbar-width: thin;\n  scrollbar-color: var(--ui-black-transparent) transparent;\n}\n\n.sa-mcp-preview-container::-webkit-scrollbar {\n  width: 8px;\n}\n\n.sa-mcp-preview-container::-webkit-scrollbar-track {\n  background: transparent;\n}\n\n.sa-mcp-preview-container::-webkit-scrollbar-thumb {\n  background: var(--ui-black-transparent);\n  border-radius: 4px;\n}\n\n.sa-mcp-preview-container::-webkit-scrollbar-thumb:hover {\n  background: var(--ui-black-transparent);\n  opacity: 0.6;\n}\n\n.sa-mcp-preview-blocks {\n  width: 100%;\n  min-height: 100%;\n  /* https://stackoverflow.com/a/22166728/8448397 */\n  float: left;\n}\n\n.sa-mcp-preview-scrollbar {\n  position: absolute;\n  width: 11px;\n  right: 0;\n  bottom: 0;\n}\n\n.sa-mcp-preview-block-bg {\n  width: 100%;\n  fill: transparent;\n  cursor: grab;\n  transition: fill 0.15s ease;\n}\n\n.sa-mcp-preview-block {\n  filter: brightness(95%);\n  cursor: grab;\n  transition: filter 0.15s ease;\n}\n\n.sa-mcp-preview-block:hover {\n  filter: brightness(100%);\n}\n\n.sa-mcp-preview-block-selection {\n  filter: brightness(108%) drop-shadow(0 2px 4px rgba(0, 0, 0, 0.2));\n}\n\n.sa-mcp-preview-block-bg-selection {\n  fill: rgba(77, 151, 255, 0.15);\n}\n\n.sa-mcp-status-bar {\n  padding: 4px 12px;\n  font-size: 0.7rem;\n  color: var(--text-primary);\n  opacity: 0.5;\n  background: var(--ui-black-transparent);\n  border-top: 1px solid var(--ui-black-transparent);\n  text-align: center;\n  font-family: monospace;\n}\n\n.sa-mcp-sound-item,\n.sa-mcp-sprite-item {\n  display: flex;\n  align-items: center;\n  padding: 8px;\n  cursor: pointer;\n  border-radius: 4px;\n  transition: background-color 0.15s ease;\n  width: 100%;\n  box-sizing: border-box;\n}\n\n.sa-mcp-sprite-item:hover {\n  background-color: rgba(77, 151, 255, 0.1);\n}\n\n.sa-mcp-sprite-item img {\n  width: 32px;\n  height: 32px;\n  margin-right: 8px;\n  object-fit: contain;\n  border-radius: 4px;\n  background: rgba(0, 0, 0, 0.05);\n}\n\n.sa-mcp-sprite-item span {\n  font-size: 25px;\n  color: var(--text-primary);\n  font-weight: 500;\n}\n\n.sa-mcp-sound-item:hover {\n  background-color: rgba(77, 151, 255, 0.1);\n}\n\n.sa-mcp-sound-item span:not(.sa-mcp-sound-icon) {\n  font-size: 25px;\n  color: var(--text-primary);\n  font-weight: 500;\n}\n\n.sa-mcp-backpack-item:hover {\n  background-color: rgba(77, 151, 255, 0.1);\n}\n\n.sa-mcp-sound-icon {\n  font-size: 25px;\n  margin-right: 8px;\n  width: 32px;\n  height: 32px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  border-radius: 4px;\n}\n\n.sa-mcp-backpack-item span:not(.sa-mcp-sound-icon) {\n  font-size: 25px;\n  color: var(--text-primary);\n  font-weight: 500;\n}\n\n.sa-mcp-sound-item span:not(.sa-mcp-sound-icon) {\n  font-size: 25px;\n  color: var(--text-primary);\n  font-weight: 500;\n}\n", ""]);
...
/*!***************************************************************!*\
  !*** ./src/addons/addons/middle-click-popup/BlockRenderer.js ***!
  \***************************************************************/
/*! exports provided: BlockComponent, renderBlock, getBlockHeight */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const BlockShapes = {
  ...
  SquareInput: {
    padding: 8,
    minWidth: 20,
    backgroundPath: width => // eslint-disable-next-line max-len
    "m -2 -16 h ".concat(width + 4, " a 4 4 0 0 1 4 4 V 12 a 4 4 0 0 1 -4 4 H -2 a 4 4 0 0 1 -4 -4 V -12 a 4 4 0 0 1 4 -4")
  },
  // eg show
  Stack: {
    padding: 8,
    minWidth: 60,
    backgroundPath: width => // eslint-disable-next-line max-len
    "m -8 -20 A 4 4 0 0 1 -4 -24 H 4 c 2 0 3 1 4 2 l 4 4 c 1 1 2 2 4 2 h 12 c 2 0 3 -1 4 -2 l 4 -4 C 37 -23 38 -24 40 -24 H ".concat(width, " a 4 4 0 0 1 4 4 v 40 a 4 4 0 0 1 -4 4 H 40 c -2 0 -3 1 -4 2 l -4 4 c -1 1 -2 2 -4 2 h -12 c -2 0 -3 -1 -4 -2 l -4 -4 c -1 -1 -2 -2 -4 -2 H -4 a 4 4 0 0 1 -4 -4 z")
  },
  ...
  Hat: {
    ...
    minWidth: 60,
    backgroundPath: width => // eslint-disable-next-line max-len
    "m -8 -20 A 4 4 0 0 1 -4 -24 H ".concat(width, " a 4 4 0 0 1 4 4 v 40 a 4 4 0 0 1 -4 4 H 40 c -2 0 -3 1 -4 2 l -4 4 c -1 1 -2 2 -4 2 h -12 c -2 0 -3 -1 -4 -2 l -4 -4 c -1 -1 -2 -2 -4 -2 H -4 a 4 4 0 0 1 -4 -4 z")
  },
  ...
  End: {
    ...
    minWidth: 60,
    backgroundPath: width => // eslint-disable-next-line max-len
    "m -8 -20 A 4 4 0 0 1 -4 -24 H 4 c 2 0 3 1 4 2 l 4 4 c 1 1 2 2 4 2 h 12 c 2 0 3 -1 4 -2 l 4 -4 C 37 -23 38 -24 40 -24 H ".concat(width, " a 4 4 0 0 1 4 4 v 40 a 4 4 0 0 1 -4 4 H -4 a 4 4 0 0 1 -4 -4 z")
  },
  ...
  HorizontalBlock: {
    padding: 16,
    minWidth: 45,
    backgroundPath: width => "M -4 -20 a 4 4 0 0 1 4 -4 H ".concat(width + 8
...
const _renderBlock = (block, container, parentCategory, isVertical) => {
  ...
  const categoryClass = COLOR_CLASSES.includes(category.name) ? "sa-block-color-".concat(category.name) : null;
  let xOffset = 0;
  let inputIdx = 0;
...
/*!***************************************************************!*\
  !*** ./src/addons/addons/middle-click-popup/BlockTypeInfo.js ***!
  \***************************************************************/
/*! exports provided: BlockInputType, BlockInstance, BlockShape, BlockInput, BlockInputRound, BlockInputString, BlockInputNumber, BlockInputBoolean, BlockInputColour, BlockInputEnum, BlockInputBlock, BlockTypeInfo */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
  ...
  */
  createWorkspaceForm() {
    if (this.typeInfo.id === 'control_stop') {
      this.typeInfo.domForm.querySelector('mutation').setAttribute('hasnext', "".concat(this.inputs[0].value === 'other scripts in sprite'));
    }
  ...
  setValue(block, value) {
    if (value instanceof BlockInstance) {
      ...
      if (!subblock.outputConnection) {
        throw new Error("Cannot put block \"".concat(subblock.typeInfo.id, "\" into a round type input."));
      }
...
class BlockInputString extends BlockInputRound {
  ...
  _toFieldValue(value) {
    ...
    throw new Error("Cannot set round type input to value of type ".concat(type));
  }
}
class BlockInputNumber extends BlockInputRound {
  ...
  _toFieldValue(value) {
    ...
    if (type === 'string') {
      ...
      if (isNaN(number)) throw new Error("Cannot set numeric type input to string \"".concat(value, "\"."));
      return value;
    }
    throw new Error("Cannot set round type input to value of type ".concat(type));
  }
  ...
  setValue(block, value) {
    if (value instanceof BlockInstance) {
      ...
      if (!subblock.outputConnection || value.typeInfo.shape !== BlockShape.Boolean) {
        throw new Error("Cannot put block \"".concat(value.typeInfo.id, "\" into a boolean type input."));
      }
      subblock.outputConnection.connect(this.getInput(block).connection);
    } else {
...
class BlockInputColour extends BlockInput {
  ...
  setValue(block, value) {
    if (typeof value !== 'string') throw new Error("Cannot set color type input to value of type ".concat(typeof type));
    if (!value.match(/^#[0-9a-fA-F]{6}$/)) throw new Error("Invalid color \"".concat(value, "\"."));
  ...
  setValue(block, value) {
    if (value instanceof BlockInstance) {
      ...
      if (!subblock.previousConnection || !value.typeInfo.shape.canStackUp) {
        throw new Error("Cannot put block \"".concat(value.typeInfo.id, "\" into a block type input."));
      }
...
class TokenTypeBlock extends TokenType {
  ...
  constructor(querier, block) {
    ...
    for (const part of block.parts) {
      if (typeof part !== "string" && part.type === _BlockTypeInfo_js__WEBPACK_IMPORTED_MODULE_0__["BlockInputType"].ENUM) {
        enumInputCount++;
      }
    }
    const _enumerateStringForms = function enumerateStringForms() {
      ...
      let enumsHandled = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 0;
      for (; partIdx < block.parts.length; partIdx++) {
        ...
        if (typeof blockPart === "string") {
          ...
          for (const enumValue of valuesToUse) {
            _enumerateStringForms(partIdx + 1, [...strings, ...enumValue.string.toLowerCase().split(" ")], [...inputs, enumValue], length + enumValue.string.length, enumsHandled + 1);
          }
          return;
        } else {
          inputs.push(null);
  ...
  *parseTokens(query, idx, depth) {
  ...
  _parseSubtokens(query, idx, subtokenProviders, depth) {
    ...
    let combinationCount = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : 0;
    return function* () {
      idx = query.skipIgnorable(idx);
      ...
      for (const token of (_tokenProvider$parseT = tokenProvider === null || tokenProvider === void 0 ? void 0 : (_tokenProvider$parseT2 = tokenProvider.parseTokens) === null || _tokenProvider$parseT2 === void 0 ? void 0 : _tokenProvider$parseT2.call(tokenProvider, query, idx, depth + 1)) !== null && _tokenProvider$parseT !== void 0 ? _tokenProvider$parseT : []) {
        var _tokenProvider$parseT, _tokenProvider$parseT2;
        ++query.tokenCount;
        ...
        if (!parseNextToken || !token.isLegal || tokenProviderIdx === subtokenProviders.length - 1) {
          ...
          for (const subTokenArr of _this2._parseSubtokens(query, token.end, subtokenProviders, depth, tokenProviderIdx + 1, !token.isTruncated, combinationCount + 1)) {
 ...
 */
_defineProperty(WorkspaceQuerier, "MAX_RESULTS", 5000);
// Increased from 2000
/**
 * The maximum number of tokens to find before giving up.
 */
_defineProperty(WorkspaceQuerier, "MAX_TOKENS", 20000);
// Increased from 10000
/**
 * The maximum number of combinations per block type.
 */
_defineProperty(WorkspaceQuerier, "MAX_COMBINATIONS_PER_BLOCK", 20);
...
/***/ "./src/addons/addons/middle-click-popup/mathUtils.js":
/*!***********************************************************!*\
  !*** ./src/addons/addons/middle-click-popup/mathUtils.js ***!
  \***********************************************************/
/*! exports provided: evaluateMath, tryUnitConversion */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "evaluateMath", function() { return evaluateMath; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "tryUnitConversion", function() { return tryUnitConversion; });
function _slicedToArray(r, e) { return _arrayWithHoles(r) || _iterableToArrayLimit(r, e) || _unsupportedIterableToArray(r, e) || _nonIterableRest(); }
function _nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return _arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? _arrayLikeToArray(r, a) : void 0; } }
function _arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; }
...
const evaluateMath = expression => {
  try {
    ...
    const result = Function("\"use strict\"; return (".concat(cleaned, ")"))();
...
const unitDefinitions = {
  ...
  temperature: {
    c: {
      names: ['c', 'celsius', '°c', 'celcius'],
      toBase: v => v,
      fromBase: v => v
    },
    // eslint-disable-next-line max-len
    f: {
      names: ['f', 'fahrenheit', '°f', 'farenheit'],
      toBase: v => (v - 32) * 5 / 9,
      fromBase: v => v * 9 / 5 + 32
    },
    k: {
...
const tryUnitConversion = input => {
  ...
  const patterns = [/^([\d.]+)\s*([a-z°'"]+)\s+(?:in|to|as)\s+([a-z°'"]+)$/i, /^([\d.]+)\s*([a-z°'"]+)\s+([a-z°'"]+)$/i // fallback: "5 cm inches"
  ];
  let match = null;
  ...
  for (const _ref of Object.entries(unitDefinitions)) {
    var _ref2 = _slicedToArray(_ref, 2);
    const category = _ref2[0];
    const units = _ref2[1];
    let fromUnit = null;
    let toUnit = null;
    for (const _ref3 of Object.entries(units)) {
    ...
    for (const _ref5 of Object.entries(units)) {
...
/***/ "./src/addons/addons/middle-click-popup/renderingUtils.js":
/*!****************************************************************!*\
  !*** ./src/addons/addons/middle-click-popup/renderingUtils.js ***!
  \****************************************************************/
/*! exports provided: renderCustomBlock, renderMenuItem, calculateActualHeight */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "renderCustomBlock", function() { return renderCustomBlock; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "renderMenuItem", function() { return renderMenuItem; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "calculateActualHeight", function() { return calculateActualHeight; });
/* harmony import */ var _BlockRenderer_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./BlockRenderer.js */ "./src/addons/addons/middle-click-popup/BlockRenderer.js");
/* harmony import */ var _uiComponents_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./uiComponents.js */ "./src/addons/addons/middle-click-popup/uiComponents.js");
      ...
      if (blocklyBlock) {
        ...
        try {
          ...
          if (tempBlock && tempBlock.getSvgRoot()) {
            ...
            if (!isNaN(blockWidth) && !isNaN(blockHeight) && isFinite(blockWidth) && isFinite(blockHeight) && blockWidth > 0 && blockHeight > 0) {
              return {
                width: blockWidth,
                height: blockHeight
              };
...
const renderMenuItem = (result, svgBlock, previewWidth, previewScale, Blockly, vm) => {
  ...
  if (result.isHeader) {
    var _result$headerText;
    height = 40;
    const foreignObject = document.createElementNS('http://www.w3.org/2000/svg', 'foreignObject');
    foreignObject.setAttribute('width', "".concat(previewWidth / previewScale));
    foreignObject.setAttribute('height', "".concat(height));
    const headerItem = Object(_uiComponents_js__WEBPACK_IMPORTED_MODULE_1__["createSectionHeader"])((_result$headerText = result.headerText) !== null && _result$headerText !== void 0 ? _result$headerText : 'Unknown Section');
    ...
    let item;
    if (result.isSprite) {
      item = Object(_uiComponents_js__WEBPACK_IMPORTED_MODULE_1__["createSpritePreviewItem"])(result.spriteData, vm);
    } else if (result.isCostume) {
      item = Object(_uiComponents_js__WEBPACK_IMPORTED_MODULE_1__["createCostumePreviewItem"])(result.costumeData);
    } else if (result.isSound) {
      item = Object(_uiComponents_js__WEBPACK_IMPORTED_MODULE_1__["createSoundPreviewItem"])(result.soundData);
    }
    if (item) {
    ...
    height = Object(_BlockRenderer_js__WEBPACK_IMPORTED_MODULE_0__["getBlockHeight"])(result.block);
    renderedBlock = Object(_BlockRenderer_js__WEBPACK_IMPORTED_MODULE_0__["renderBlock"])(result.block, svgBlock);
  }
...
/***/ "./src/addons/addons/middle-click-popup/searchUtils.js":
/*!*************************************************************!*\
  !*** ./src/addons/addons/middle-click-popup/searchUtils.js ***!
  \*************************************************************/
/*! exports provided: performSearch */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "performSearch", function() { return performSearch; });
/* harmony import */ var _vmHelpers_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./vmHelpers.js */ "./src/addons/addons/middle-click-popup/vmHelpers.js");
/* harmony import */ var _mathUtils_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./mathUtils.js */ "./src/addons/addons/middle-click-popup/mathUtils.js");
 ...
 *   }} Search results
 */
const performSearch = function performSearch(searchValue, querier, blockTypes, vm, PREVIEW_LIMIT) {
  let searchMode = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 'everything';
  /** @type {MenuItem[]} */
  const blockList = [];
  ...
  if (searchValue.trim().length === 0) {
    ...
    const searchTerms = searchValue.toLowerCase().split(/\s+/).filter(t => t.length > 0);
    let spriteResults = [];
    if (searchEverything) {
      const sprites = Object(_vmHelpers_js__WEBPACK_IMPORTED_MODULE_0__["getAllSprites"])(vm);
    ...
    let costumeResults = [];
    if (searchEverything) {
      const costumes = Object(_vmHelpers_js__WEBPACK_IMPORTED_MODULE_0__["getAllCostumes"])(vm);
    ...
    let soundResults = [];
    if (searchEverything) {
      const sounds = Object(_vmHelpers_js__WEBPACK_IMPORTED_MODULE_0__["getAllSounds"])(vm);
    ...
    if (searchEverything) {
      const customBlocks = Object(_vmHelpers_js__WEBPACK_IMPORTED_MODULE_0__["getAllCustomBlocks"])(vm);
    ...
    mathResult = Object(_mathUtils_js__WEBPACK_IMPORTED_MODULE_1__["evaluateMath"])(searchValue);
    if (!mathResult) {
      conversionResult = Object(_mathUtils_js__WEBPACK_IMPORTED_MODULE_1__["tryUnitConversion"])(searchValue);
    }
  }
  return {
    blockList,
...
/***/ "./src/addons/addons/middle-click-popup/selectionUtils.js":
/*!****************************************************************!*\
  !*** ./src/addons/addons/middle-click-popup/selectionUtils.js ***!
  \****************************************************************/
/*! exports provided: findNextSelectableIndex, handleSpriteSelection, handleCostumeSelection, handleCustomBlockSelection, handleSoundSelection, handleBlockSelection */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "findNextSelectableIndex", function() { return findNextSelectableIndex; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "handleSpriteSelection", function() { return handleSpriteSelection; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "handleCostumeSelection", function() { return handleCostumeSelection; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "handleCustomBlockSelection", function() { return handleCustomBlockSelection; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "handleSoundSelection", function() { return handleSoundSelection; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "handleBlockSelection", function() { return handleBlockSelection; });
...
/***/ "./src/addons/addons/middle-click-popup/uiComponents.js":
/*!**************************************************************!*\
  !*** ./src/addons/addons/middle-click-popup/uiComponents.js ***!
  \**************************************************************/
/*! exports provided: createSpritePreviewItem, createCostumePreviewItem, createSectionHeader, createCustomBlockPreviewItem, createSoundPreviewItem */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createSpritePreviewItem", function() { return createSpritePreviewItem; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createCostumePreviewItem", function() { return createCostumePreviewItem; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createSectionHeader", function() { return createSectionHeader; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createCustomBlockPreviewItem", function() { return createCustomBlockPreviewItem; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createSoundPreviewItem", function() { return createSoundPreviewItem; });
...
const createCustomBlockPreviewItem = customBlockData => {
  ...
  targetLabel.textContent = "in ".concat(customBlockData.targetName);
...
/* harmony import */ var _searchUtils_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./searchUtils.js */ "./src/addons/addons/middle-click-popup/searchUtils.js");
/* harmony import */ var _renderingUtils_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./renderingUtils.js */ "./src/addons/addons/middle-click-popup/renderingUtils.js");
/* harmony import */ var _selectionUtils_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./selectionUtils.js */ "./src/addons/addons/middle-click-popup/selectionUtils.js");
// @ts-check
/* eslint-disable */
...
/* harmony default export */ __webpack_exports__["default"] = (async function (_ref) {
  ...
  */
  ...
  function openPopup() {
    let centered = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
    if (addon.self.disabled) return;
    ...
    popupContainer.style.width = "".concat(previewWidth, "px");
    if (centered) {
      previewWidth = 600;
      popupOrigin = {
    ...
    popupRoot.style.top = "".concat(popupPosition.y, "px");
    popupRoot.style.left = "".concat(popupPosition.x, "px");
    popupInput.value = '';
  ...
  function loadBlockTypes(workspace) {
    try {
      blockTypes = _BlockTypeInfo_js__WEBPACK_IMPORTED_MODULE_2__["BlockTypeInfo"].getBlocks(Blockly, vm, workspace, msg);
  ...
  function doPerformSearch() {
    ...
    const searchResult = Object(_searchUtils_js__WEBPACK_IMPORTED_MODULE_4__["performSearch"])(popupInput.value, querier, blockTypes, vm, PREVIEW_LIMIT, searchMode);
    ...
    if (popupInput.value.trim().length === 0) {
      ...
      if (searchResult.mathResult !== null) {
        popupResultBox.textContent = "= ".concat(searchResult.mathResult);
        ...
        popupResultBox.textContent = "= ".concat(resultStr, " ").concat(searchResult.conversionResult.toUnit);
        popupResultBox.style.display = '';
      ...
      if (hasComputed && searchCount > 0) {
        statusText = "".concat(searchCount, " result").concat(searchCount !== 1 ? 's' : '');
      } else if (searchCount > 0) {
        statusText = "".concat(searchCount, " result").concat(searchCount !== 1 ? 's' : '');
      } else {
        statusText = 'No results found';
      }
      statusText += " (".concat(searchTime, "ms)");
      if (limited) {
    ...
    for (let resultIdx = 0; resultIdx < blockList.length; resultIdx++) {
      ...
      const _renderMenuItem = Object(_renderingUtils_js__WEBPACK_IMPORTED_MODULE_5__["renderMenuItem"])(result, svgGroup, previewWidth, previewScale, Blockly, vm),
        renderedBlock = _renderMenuItem.renderedBlock,
        height = _renderMenuItem.height;

      /** @type {SVGGElement} */
      const svgBlock = svgGroup;
      if (!renderedBlock || !svgBlock) continue; // Skip if we couldn't render

      const actualHeight = Object(_renderingUtils_js__WEBPACK_IMPORTED_MODULE_5__["calculateActualHeight"])(result, renderedBlock, height);
      if (isNaN(y)) {
        y = 0;
      }
      ...
      svgBackground.setAttribute('transform', "translate(0, ".concat((y + bgOffset) * previewScale, ")"));
      svgBackground.setAttribute('height', "".concat(actualHeight * previewScale, "px"));
      queryPreviews.push({
        block: result.block,
    ...
    popupPreviewBlocks.setAttribute('height', "".concat(isNaN(totalHeight) ? previewMinHeight : totalHeight, "px"));
    popupPreviewContainer.style.height = "".concat(previewHeight, "px");
    popupPreviewScrollbarSVG.style.height = "".concat(previewHeight, "px");
    popupPreviewScrollbarBackground.setAttribute('height', "".concat(previewHeight));
    popupInputContainer.dataset.error = "".concat(limited);
  ...
  function updateSelection(/** @type {number} */newIdx) {
    ...
    const actualIdx = Object(_selectionUtils_js__WEBPACK_IMPORTED_MODULE_6__["findNextSelectableIndex"])(queryPreviews, newIdx, selectedPreviewIdx);
    if (actualIdx === -1) {
      selectedPreviewIdx = -1;
      return;
    }
  ...
  function updateCursor() {
    ...
    for (let previewIdx = 0; previewIdx < queryPreviews.length; previewIdx++) {
      ...
      if (preview.isHeader) {
        ...
        const customHeight = preview.renderedBlock && typeof preview.renderedBlock === 'object' && 'height' in preview.renderedBlock ? preview.renderedBlock.height : undefined;
        y += customHeight && !isNaN(customHeight) ? customHeight + 10 : 60;
      } else if (preview.block) {
        const blockHeight = Object(_BlockRenderer_js__WEBPACK_IMPORTED_MODULE_1__["getBlockHeight"])(preview.block);
  ...
  function updateScrollbar() {
    ...
    if (!isNaN(scrollbarHeight) && !isNaN(scrollbarY) && scrollbarHeight > 0) {
      ...
      popupPreviewScrollbarHandle.setAttribute('height', "".concat(scrollbarHeight));
      popupPreviewScrollbarHandle.setAttribute('y', "".concat(scrollbarY));
    } else {
      popupPreviewScrollbarSVG.style.display = 'none';
    }
  }
  function selectBlock() {
    ...
    if (selectedPreview.isSprite && selectedPreview.spriteData) {
      Object(_selectionUtils_js__WEBPACK_IMPORTED_MODULE_6__["handleSpriteSelection"])(selectedPreview.spriteData, vm);
      closePopup();
      return;
    }
    if (selectedPreview.isCostume && selectedPreview.costumeData) {
      Object(_selectionUtils_js__WEBPACK_IMPORTED_MODULE_6__["handleCostumeSelection"])(selectedPreview.costumeData, vm, addon.tab.redux);
      closePopup();
      return;
    }
    if (selectedPreview.isSound && selectedPreview.soundData) {
      Object(_selectionUtils_js__WEBPACK_IMPORTED_MODULE_6__["handleSoundSelection"])(selectedPreview.soundData, vm, addon.tab.redux);
      closePopup();
      return;
    }
    if (selectedPreview.isCustomBlock && selectedPreview.customBlockData) {
      Object(_selectionUtils_js__WEBPACK_IMPORTED_MODULE_6__["handleCustomBlockSelection"])(selectedPreview.customBlockData, vm, Blockly, addon.tab.redux);
      closePopup();
      return;
    }
    if (!selectedPreview.block) return;
    const newBlock = Object(_selectionUtils_js__WEBPACK_IMPORTED_MODULE_6__["handleBlockSelection"])(selectedPreview.block, Blockly, mousePosition);
    const fakeEvent = {
...
/***/ "./src/addons/addons/middle-click-popup/vmHelpers.js":
/*!***********************************************************!*\
  !*** ./src/addons/addons/middle-click-popup/vmHelpers.js ***!
  \***********************************************************/
/*! exports provided: getAllSprites, getAllCostumes, getAllCustomBlocks, getAllSounds */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getAllSprites", function() { return getAllSprites; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getAllCostumes", function() { return getAllCostumes; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getAllCustomBlocks", function() { return getAllCustomBlocks; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getAllSounds", function() { return getAllSounds; });
    ...
    if (target.isOriginal) {
      ...
      for (const blockId in blocks._blocks) {
        ...
        if (block.opcode === 'procedures_definition') {
          var _block$inputs$custom_;
          const prototypeBlockId = (_block$inputs$custom_ = block.inputs.custom_block) === null || _block$inputs$custom_ === void 0 ? void 0 : _block$inputs$custom_.block;
          if (prototypeBlockId) {
